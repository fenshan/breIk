...
{
    public static float RANGE = 0.20f; // min: 2 layers // max: 4 layers // [because bad things pop up in a random place in a range of the currentScroll]
    public static float MAX_VOLUME_BAD = 0.35f;
